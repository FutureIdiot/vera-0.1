...
| Account系统管理 | `#/settings/accounts`、`#/settings/accounts/:accountId` | 新建/删除/命名Account，生成/轮换/撤销接入Key，查看所属/当前Agent、Workspace、Space与登录审计 | Agent Memory正文、Skills/Hooks/MCP/Data；provider/model表单；直接创建空Agent |
