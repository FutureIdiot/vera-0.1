const ICONS = {
  archive: [
    ["path", { d: "M4.5 8h15v11.5h-15zM3.5 4.5h17v3.5h-17zM9 12h6" }],
  ],
  "arrow-left": [
  ...
  chat: [
    ["path", { d: "M20.5 12a8.5 8.5 0 01-12.3 7.6L3.5 21l1.3-4.8A8.5 8.5 0 1120.5 12z" }],
  ...
  garage: [
    ["path", { d: "M3.5 20V9.2a2 2 0 011.2-1.8l6.5-2.9a2 2 0 011.6 0l6.5 2.9a2 2 0 011.2 1.8V20M7 20v-6.5h10V20M7 17h10M2.5 20h19" }],
  ],
  command: [
  ...
  compose: [
    ["path", { d: "M13 4.5H6.5a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2V11" }],
    ["path", { d: "M11 13l.8-3.2 5.6-5.6a1.8 1.8 0 012.5 2.5l-5.6 5.6z" }],
  ],
  copy: [
  ...
  library: [
    ...
    ["path", { d: "M16.5 5l3.2 13.2a1 1 0 01-.7 1.2l-1.3.3M3.5 9h4M9.5 9h4" }],
  ],
  edit: [
  ...
  notebook: [
    ["path", { d: "M6 3.5h11a2 2 0 012 2v13a2 2 0 01-2 2H6a1 1 0 01-1-1v-15a1 1 0 011-1zM9 3.5v17M12.5 9h3.5M12.5 13h3.5" }],
  ],
  observe: [
  ...
  pin: [
    ["path", { d: "M9 3.5h6l-1 5 3 3v2H7v-2l3-3-1-5zM12 13.5V21" }],
  ],
  plus: [
  ...
  trash: [
    ["path", { d: "M4.5 7h15M9 7V4.5h6V7M7 7l1 13h8l1-13M10 10.5v6M14 10.5v6" }],
  ],
  usage: [
