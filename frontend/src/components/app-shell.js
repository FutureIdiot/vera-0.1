...
function defaultManagementHeader(routeName, currentSpace) {
  ...
  const defaults = {
    ...
    "agent-skills": { title: "Skills", backHref: "#/settings/accounts", backLabel: "返回" },
    "agent-hooks": { title: "Hooks", backHref: "#/settings/accounts", backLabel: "返回" },
    "agent-mcp": { title: "MCP", backHref: "#/settings/accounts", backLabel: "返回" },
    "agent-data": { title: "Data", backHref: "#/settings/accounts", backLabel: "返回" },
    "agent-memory-config": { title: "Memory", backHref: "#/settings/accounts", backLabel: "返回" },
    "agent-memory-library": { title: "Memory Library", backHref: "#/settings/accounts", backLabel: "返回" },
