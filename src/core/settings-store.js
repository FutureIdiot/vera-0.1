...
function deriveDefaults(config) {
  ...
  return {
    ...
    "appearance.fontSize.phone.chat": fs.phone?.chat ?? 12,
    "appearance.fontSize.phone.management": fs.phone?.management ?? 13,
    "appearance.fontSize.desktop.chat": fs.desktop?.chat ?? 13,
    "appearance.fontSize.desktop.management": fs.desktop?.management ?? 14,
